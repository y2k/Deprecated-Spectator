...
namespace Spectator.Core.Model.Web
{
    ...
    public class PersistenCookieContainer
    {
        ...
        public static PersistenCookieContainer LoadFromFileOrCreateEmpty(Uri baseUrl)
        {
            ...
            return new PersistenCookieContainer { Cookies = c, cookieMap = map, baseUrl = baseUrl };
        }
